...
+ (UIImage *)standardLoadingImage {
    static UIImage* standardLoadingImage;
    if (standardLoadingImage == nil) {
        NSURL *url = [[NSBundle mainBundle] URLForResource:@"loading2" withExtension:@"gif"];
        standardLoadingImage = [UIImage animatedImageWithAnimatedGIFURL:url];
    }
    return standardLoadingImage;
}
